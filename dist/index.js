...
var u=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),d=require('@stdlib/symbol-iterator/dist'),h=require('@stdlib/constants-float64-max-safe-integer/dist'),w=l(),A=(h+1)/2;function c(t){var r,e,v,i,n,a;if(r={iter:A},arguments.length&&(i=w(r,t),i))throw i;return n=0,a=-1,e={},u(e,"next",q),u(e,"return",O),d&&u(e,d,p),e;function q(){return n+=1,v||n>r.iter?{done:!0}:(a+=2,{value:a,done:!1})}function O(E){return v=!0,arguments.length?{value:E,done:!0}:{done:!0}}function p(){return c(r)}}g.exports=c
